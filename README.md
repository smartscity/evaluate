...
To build the final jar and optimize the evaluate application for production, run:
...
[doing api-first development]: https://www.jhipster.tech/documentation-archive/v6.0.0-beta.0/doing-api-first-development/
