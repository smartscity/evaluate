package com.smartscity.evaluate.config;

import com.smartscity.evaluate.security.*;
import com.smartscity.evaluate.security.jwt.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter implements InitializingBean {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/evaluations1").permitAll()
